...
#matrix = customer_data.corr(numeric_only=True)
...
col_param_1 = matrix.index[leastCorrelatedCols[0][0]] 
col_param_2 = matrix.index[leastCorrelatedCols[1][0]] 



# What is the max positive value present in the matrix that is not equal to 1
matrix_max = matrix[matrix < 1].max().max()
